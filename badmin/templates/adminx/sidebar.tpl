...
<div class="side-bar-shortcut-links">
    ...
    <ul>
        ...
        <li><a href="#" data-toggle="modal" data-target="#modalGenerateInvoices">{$_ADMINLANG.invoices.geninvoices}</a></li>
        <li><a href="#" data-toggle="modal" data-target="#modalCreditCardCapture">{$_ADMINLANG.invoices.attemptcccaptures}</a></li>
    </ul>
</div>
