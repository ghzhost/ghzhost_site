...
<head>
    ...
    {include file="$template/includes/metatags.tpl"}
 ...
 <div class="animation-header"><!-- HEADRR ANIMATION -->
    ...
    <div class="container">
        ...
        {if $languagechangeenabled && count($locales) > 1}
            <li>
                <a href="#" class="choose-language" data-toggle="popover" id="languageChooser"><img src="https://flagcdn.com/w20/{$activeLocale.countryCode|strtolower}.png">
                    {$activeLocale.localisedName}{if !$loggedin && count($currencies) > 1} / {$activeCurrency.code} [{$activeCurrency.prefix}] {/if}
                    <b class="caret"></b>
                </a>
                ...
                <div id="languageChooserContent" class="hidden">
                    <ul>
                        {foreach $locales as $locale}
                            <li>
                            <a href="{$currentpagelinkback}language={$locale.language}"><img src="https://flagcdn.com/w20/{$locale.countryCode|strtolower}.png"> {$locale.localisedName}</a>
                    ...
                    {if !$loggedin && count($currencies) > 1}
                        ...
                        {foreach from=$currencies item=currchoice}
                            <li><a href="{$currentpagelinkback}currency={$currchoice.id}"><img src="https://flagcdn.com/w20/{$currchoice.code|substr:0:2|strtolower}.png"> {$currchoice.code} [{$currchoice.prefix}]</a></li>
                        {/foreach}
                        </ul>
                    {/if}
                </div>
                ...
                <div class="navbar-header">
                    ...
                    {if $logo}
                        ...
                        <div class="logo-container">
                            <img src="{$logo}" alt="{$companyname}" class="logo-img">
                            <img src="https://flagcdn.com/w40/{$flag_url[0]|lower}.png" alt="FLAG" class="flag">
                        </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="fetures-place  wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <p>{$LANG.cartproductdomainchoose}</p>
                            <span>{$LANG.buyadomain_p}</span>
                    ...
                    <div class="col-md-3">
                        <div class="fetures-place  wow fadeIn" data-wow-delay="0.6s">
                            ...
                            <p>{$LANG.orderpaymentmethod}</p>
                            <span>{$LANG.makepayment_span}</span>
                    ...
                    <div class="col-md-3">
                        <div class="fetures-place  wow fadeIn" data-wow-delay="0.9s">
                            ...
                            <p>{$LANG.orderhosting_p}</p>
                            <span>{$LANG.orderhosting_span}</span>
